...
$(document).ready(function(){
    setInterval(function() {
        ...
        $.getJSON('quotes/security', {ticker: '@CL.1', yticker: 'CL'+monthcode[month]+year, country: 'NYM', action: 'futures'}, function(security) {
        ...
        $.getJSON('quotes/security', {ticker: '@NG.1', yticker: 'NG'+monthcode[month]+year, country: 'NYM', action: 'futures'}, function(security) {
        ...
        $.getJSON('quotes/security', {ticker: '@GC.1', yticker: 'GC'+monthcode[month]+year, country: 'CMX', action: 'futures'}, function(security) {
        ...
        $.getJSON('quotes/security', {ticker: '@DJ.1', yticker: 'DJ'+monthcode[month]+year, country: '', action: 'futures'}, function(security) {
        ...
        $.getJSON('quotes/security', {ticker: '@SP.1', yticker: 'SP'+monthcode[month]+year, country: '', action: 'futures'}, function(security) {
        ...
        $.getJSON('quotes/security', {ticker: '@ND.1', yticker: 'ND'+monthcode[month]+year, country: '', action: 'futures'}, function(security) {
